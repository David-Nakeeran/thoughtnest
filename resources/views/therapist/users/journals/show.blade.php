                ...
                <div x-cloak x-show="showModal"
                    ...
                    <div class="w-full max-w-xl bg-white rounded-2xl border border-[#E5E7EB] shadow-lg p-6 space-y-4"
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <button @click="showModal = false" class="text-[#6B7280] hover:text-[#1F2937] text-xl">
                                ✕
                            </button>
                        </div>
                        ...
                        <form method="POST"
                            ...
                            <div class="space-y-1">
                                ...
                                <textarea name="comment" required
                                    class="w-full min-h-[120px] rounded-xl border border-[#E5E7EB] px-4 py-3 text-sm
                                           focus:outline-none focus:ring-2 focus:ring-[#2DD4BF]/30 focus:border-[#2DD4BF]
